...
import {
  getOrgDetails,
  updateOrganisationDetailsSuperAdmin,
...
const UpdateOrganisationSuperAdmin = () => {
  ...
  const updateFormSubmitHandler = e => {
    ...
    dispatch(updateOrganisationDetailsSuperAdmin(myForm));
...
export default UpdateOrganisationSuperAdmin;
